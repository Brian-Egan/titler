...
(function() {
  var submitAdjectiveForm;

  $(document).on('click', ".addWordBtn", function() {
    var form;
  ...
  submitAdjectiveForm = function(form) {
    var wordForm;
    console.log("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=");
...
(function() {
  $(document).delegate(".refreshMonster", "click", function() {
